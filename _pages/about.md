...
Previously, I worked as a Software Development Intern at [Erin Technologies](/posts/2025-8-20-internship), where I focused on building and modernizing production software systems. My work centered on backend and cloud infrastructure, including developing AWS Lambda–based services, refactoring legacy notification logic into modular and testable components, and supporting data pipelines used for analytics and reporting. This experience strengthened my ability to work within real operational constraints, collaborate across teams, and take ownership of software that directly supports production workflows.
<!-- 
Currently, I am working with the Carley Lab at Carnegie Mellon University on a Societal Computing independent study focused on cybersecurity simulation and defense modeling. My work involves designing and implementing agent-based models that simulate realistic cyber defense behavior, drawing on the MITRE ATT&CK and MITRE D3FEND frameworks. From a software engineering perspective, this includes building simulation infrastructure, implementing defender agents with structured decision logic and human-factor constraints, and developing extensible Python-based modeling environments to evaluate system behavior under diverse attack scenarios. The project emphasizes translating theoretical frameworks into executable systems, validating model behavior, and iterating on architecture to support scalable and realistic simulations. -->
